...
import { Form, FormField, TextInput, Box, Button, CheckBox } from "grommet";
...
export const AddCoordinateForm = (
  ...
  return (
    ...
    >
      ...
      <FormField label="X coordinate" name="x">
        <TextInput
          name="X"
          value={x}
      ...
      <FormField label="Y coordinate" name="y">
        <TextInput
          name="y"
          value={y}
      ...
      <FormField label="Z coordinate" name="z">
        <TextInput
          name="z"
          value={z}
